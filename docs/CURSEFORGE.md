...
**Requirements:** a Hytale server. **Supported Hytale versions:** release line 0.6.3 to 0.6.5 (`LowTalk-0.2.0.jar`),
pre-release line 0.7.0-pre.2 (`LowTalk-0.2.0+hytale.0.7.0-pre.2.jar`); one jar per line is attached to each GitHub
