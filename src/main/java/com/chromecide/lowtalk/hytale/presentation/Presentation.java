 ...
 */
public record Presentation(@Nonnull DialogueLayout layout, @Nonnull Set<String> hideHud) {

    public Presentation {
        hideHud = Collections.unmodifiableSet(new LinkedHashSet<>(hideHud));
    }

    public static Presentation of(DialogueLayout layout, List<String> hideHud) {
        return new Presentation(layout, new LinkedHashSet<>(hideHud));
    }
     ...
     */
    public record Defaults(DialogueLayout layout, List<String> hideHud) {
        public static final Defaults NONE = new Defaults(null, null);

        public boolean isEmpty() { return layout == null && hideHud == null; }
    }
}
