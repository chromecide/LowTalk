...
class JsonConvertTest {
    ...
    void roundTripThroughAsset() {
        ...
        assertInstanceOf(JsonStatement.Command.class, body.get(11), "objective cancel stays a generic command");
        ...
        JsonStatement.Command notify = assertInstanceOf(JsonStatement.Command.class, body.get(14));
        assertArrayEquals(new String[] {"Hi {player}", "d", "success"}, notify.args);
